...
await page.click('.rc-pager-arrow[aria-label="Próximo reforço"]')
await page.waitForTimeout(300)
await page.screenshot({ path: 'C:/Users/fabio/AppData/Local/Temp/claude/C--Users-fabio-OneDrive-Documents-GitHub-cm/c2578583-4228-40b3-9a93-3ee07ab8eb6e/scratchpad/ui-eval/viewport/market-page3.png' })
await browser.close()
