...
const [, , stateName, url, outPath, click1, click2, elemSel] = process.argv
...
await page.click(click1); await page.waitForTimeout(400)
await page.click(click2); await page.waitForTimeout(400)
